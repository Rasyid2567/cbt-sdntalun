...
- Workspace ID: `4d85a6db-2337-411a-b840-eb3168436343`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/4d85a6db-2337-411a-b840-eb3168436343.
...
2. `npx ngodingpakeai connect --workspace 4d85a6db-2337-411a-b840-eb3168436343 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/4d85a6db-2337-411a-b840-eb3168436343. Only pass on links the CLI actually printed — never assemble one from an id yourself.
